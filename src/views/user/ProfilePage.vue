  ...
  <AppLayout>
    <div class="flex flex-wrap items-end justify-between gap-4">
      <div>
        ...
        <h1 class="mt-2 text-4xl font-black tracking-tight">账号资料</h1>
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-2">
      <section class="soft-card p-6">
        ...
        <div class="mt-5 space-y-4">
          ...
          <button class="rounded-full bg-sky-500 px-5 py-3 text-sm font-black text-white transition hover:bg-sky-600" @click="saveProfile">保存资料</button>
      ...
      <section class="soft-card p-6">
        ...
        <div class="mt-5 space-y-4">
          ...
          <button class="rounded-full bg-slate-950 px-5 py-3 text-sm font-black text-white transition hover:bg-slate-800" @click="changePassword">确认修改</button>
